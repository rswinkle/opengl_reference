...
int main(int argc, char** argv)
{
	...
	// we do not need a vao in compatibility profile ...
	//GLuint vao;
	...
	// client arrays apparently work in 3.3 compatibility mode
...
void setup_context()
{
	...
	window = SDL_CreateWindow("Client Arrays on GL 3.3 Compatibility Profile", 100, 100, WIDTH, HEIGHT, SDL_WINDOW_OPENGL);
	if (!window) {
		cleanup();
		exit(0);
	}
